# -*- coding: utf-8 -*-
"""Model_and_train_csv_(2) (5).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qySWk1t5d0EkVPWtmAvNY6OfUGMP3oQ_
"""
...
#need not run this as corrupted files have been removed
import glob
import torch
import torchvision
...
video_fil += glob.glob('/content/drive/MyDrive/DFDC_FAKE_Face_only_data/*.mp4')
video_fil += glob.glob('/content/drive/MyDrive/DFDC_REAL_Face_only_data/*.mp4')
...
# Load video files
video_files = glob.glob('/content/drive/MyDrive/Datasets/Celeb_fake_face_only/*.mp4')
video_files += glob.glob('/content/drive/MyDrive/Datasets/Celeb_fake_face_only/*.mp4')
video_files += glob.glob('/content/drive/MyDrive/Datasets/DFDC_FAKE_Face_only_data/*.mp4')
video_files += glob.glob('/content/drive/MyDrive/Datasets/DFDC_REAL_Face_only_data/*.mp4')
video_files += glob.glob('/content/drive/MyDrive/Datasets/FF_Face_only_data/*.mp4')
...
if not video_files:
    print("No video files found. Check the file paths.")
    exit()

#Below is the code to process videos that are shorter than 100 frames. It's been commented out as those videos have been deleted from the dataset, and hence need not be processed again.
#frame_count = []
...
#     if total_frames < 100:
#         print(f"Skipping {video_file}: Too few frames ({total_frames})")
#         video_files.remove(video_file)
#         continue

#     frame_count.append(total_frames)
#     print(f"Processed {idx}/{len(video_files)}: {video_file} with {total_frames} frames", end="\r")
...
for epoch in range(1, num_epochs+1):
    ...
    print(f"Epoch {epoch}/{num_epochs} - Train Loss: {l:.4f}, Test Loss: {tl:.4f}, Test Accuracy: {t_acc:.4f}")
